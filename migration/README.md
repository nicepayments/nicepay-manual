...
| payMethod         | String  |   O   |   10   | 결제수단<br><br>card:신용카드, card:신용카드,<br>naverpay=네이버페이, kakaopay=카카오페이, payco=페이코, ssgpay=SSGPAY, samsungpay=삼성페이                                                                          |
...
| ediDate       | String |  　  |  -   | 전문생성일시<br> ISO 8601 형식 <br> (signData 를 사용하려는 경우 필수 값)                                                                                                                                                                                                                                       |
...
| orderId        |             | String |   O    |  64  | 상점 거래 고유번호                                                                                                                                                                                                                                                                                                                                                                                          |
| ediDate        |             | String |        |  14  | 응답전문생성일시<br>ISO 8601 형식                                                                                                                                                                                                                                                                                                                                                                             |
| signature      |             | String |   　    | 256  | 위변조 검증 데이터<br>- 유효한 거래건에   한하여 응답<br>- 생성규칙 :   hex(sha256(tid + amount + ediDate+ SecretKey))<br>- SecretKey는 가맹점관리자에 로그인 하여 확인 가능합니다.                                                                                                                                                                                                                                                             |
...
| approvedAt     |             | String |   O    |  -   | 발급시점<br>ISO 8601 형식<br>발급완료가 아닐 경우 0                                                                                                                                                                                                                                                                                                                                                                |
| payMethod      |             | String |   O    |  10  | 결제수단 <br/> cshrcpt=현금영수증                                                                                                                                                                                                                                                                                                                                                                            |
| amount         |             |  Int   |        |  12  | 결제 금액                                                                                                                                                                                                                                                                                                                                                                                               |
| balanceAmt     |             |  Int   |   O    |  12  | 취소 가능한 잔액<br>부분취소 거래인경우, 전체금액에서   현재까지 취소된 금액을 차감한 금액.                                                                                                                                                                                                                                                                                                                                              |
| goodsName      |             | String |   O    |  40  | 상품명<br><br>상품이름 (", * 특수문자 이용불가)                                                                                                                                                                                                                                                                                                                                                                    |
| approveNo      |             | String |   　    |  30  | 현금영수증 국세청 취소 승인번호<br> 취소 성공시 리턴됩니다.                                                                                                                                                                                                                                                                                                                                                                 |
