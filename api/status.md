...
### 거래 조회
👉 [거래 조회](./status-transaction.md)

나이스페이 통해 발생된 거래를 tid(거래id), orderId(주문번호)를 통해 조회 할 수 있습니다.

---

### 약관 조회
👉 [약관 조회](./status-terms.md)  

💡 결제창 없이 결제를 제공하는 경우 노출해야 하는 약관 데이터를 조회 할 수 있습니다.

---

### 카드 이벤트 조회
👉 [카드 이벤트 조회](./status-event.md)  

카드사가 진행하는 할부 이벤트 정보를 조회 할 수 있습니다.

---

### 카드 무이자 조회
👉 [카드 무이자 조회](./status-interest.md)  

카드 무이자 정보 조회가 필요할 때 사용 할 수 있습니다.
