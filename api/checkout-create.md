...
### 설명
체크아웃 발급 API는 가맹점이 JS SDK를 사용하지 않고 결제창을 호출할 수 있는 link를 응답 받는 서비스입니다.
이후 링크 호출 시(체크아웃 승인) 단계로 결제창을 호출하여 결제를 진행할 수 있습니다.
...
|       필드        |   타입    | 필수 | 길이 | 설명          | 상세설명                                                                                                                                                                                                                         |
|:---------------:|:-------:|:--:|----|-------------|:-----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
|   vbankHolder   | String  | O  | 40 | 가상계좌        | **[주의사항]** <br/> - 가상계좌 요청 시 필수 값 <br/> - 가맹점 상호명, 사용자명을 입력                                                                                                                                                                  |
